...
# model checkpoint
checkpointer = tf.keras.callbacks.ModelCheckpoint(filepath='/home/kiara/testing_SEGMENTATION/unet_without_dropout_layers.h5', verbose = 2, save_weights_only = True)
callbacks = [
    tf.keras.callbacks.EarlyStopping(patience = 20, monitor = 'val_loss'),
    tf.keras.callbacks.TensorBoard(log_dir = 'UNET_No_Dropout_Layers')
]
...
model.save('model_UNET_No_Dropout_Layers')


# In[29]:


get_ipython().system('tensorboard --logdir=UNET_No_Dropout_Layers/ --host localhost --port 8000')
